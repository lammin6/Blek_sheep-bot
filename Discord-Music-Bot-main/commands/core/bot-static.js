    ...
    execute(client, message) {
        let button = new MessageActionRow().addComponents(
            ...
            .setCustomId("del"))
                ...
                .setFooter({ text: 'Music Bot Commands - by amarwhy#3272 ❤️', iconURL:message.author.avatarURL({ dynamic: true }) })
                .setDescription(`**
            > Guilds: \`${client.guilds.cache.size}\`
            > Users: \`${Math.ceil(client.guilds.cache.reduce((a, b) => a + b.memberCount, 0).toLocaleString("tr-TR"))}.000\`
            > Channels: \`${client.channels.cache.size}\`**`)
                .addField("Invite Bot", `**[Add Me](https://discord.com/api/oauth2/authorize?client_id=958500140719693844&permissions=8&scope=bot)**` ,true)
